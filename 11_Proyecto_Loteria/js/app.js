...
// 
let obj=tarjetas.shift()
console.log(obj.nombre);
console.log(tarjetas);
// -------------------------------------
let tablero1 = tarjetas.slice(0, 15);
console.log(tablero1);
let tablero2 = tarjetas.slice(16, 31);
console.log(tablero2);
let tablero3 = tarjetas.slice(32, 47);
...
// console.log(tab1);
// tab1.setAttribute("src", tablero1[0].img);

// document.getElementsByName('jugador1')[0].value
function iaddon() {
  addon = 0;
  av = document.getElementsByName("jugador1");
  console.log(av);
  for (e = 0; e < av.length; e++) {
    console.log(av[0])
    if (av[e].checked == true) {
      console.log("Si esta check")
      console.log(tarjetas[contador].nombre)
      if (av[e].value == tarjetas[contador].nombre) {
...
btninicio.addEventListener("click", function () {
  ...
  card.setAttribute("class", "card mx-auto text-center my-4 visible");
